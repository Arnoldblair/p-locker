...
class TestPassword(unittest.TestCase):
    ...
    def setUp(self):
        # self.new_credentials = Password("Facebook", "Arnold","Blair", "munene12") #Create user credential object
        
        
        self.new_credentials = Password("Facebook","Arnold","Blair","munene12")
    ...
    def test__init(self):
        ...
        self.assertEqual(self.new_credentials.first_name,"Arnold")
        self.assertEqual(self.new_credentials.last_name,"Blair")
        self.assertEqual(self.new_credentials.user_password,"munene12")
    ...
    def test_save_multiple_credentials(self):
        self.new_credentials.save_credential()
        test_credentials = Password("Instagram", "Arnold", "blair", "arnoldblair")
